        ...
        >
          ...
          <div className="relative text-center">
            ...
            <button
              ...
              className="group mt-12 inline-flex items-center gap-3 rounded-2xl bg-gradient-to-r from-cyan-400 to-violet-500 px-8 py-4 text-lg font-semibold text-white transition-all duration-300 hover:scale-105 hover:shadow-[0_0_35px_rgba(34,211,238,.4)]"
            >
              Launch Workspace
